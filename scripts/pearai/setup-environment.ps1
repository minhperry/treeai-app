...
function Initialize-BaseFunctionality {
    ...
    Set-Location .\extensions\treeai-submodule
...
function Create-SymLink {
    Write-Host "`nCreating symbolic link 'extensions\treeai-ref' -> 'extensions\treeai-submodule\extensions\vscode'" -ForegroundColor White
...
$modulePath = Join-Path -Path $currentDir -ChildPath 'extensions\treeai-submodule'
$targetPath = Join-Path -Path $modulePath -ChildPath 'extensions\vscode'
$linkPath = Join-Path -Path $currentDir -ChildPath 'extensions\treeai-ref'
