...
const openblueberryAIChat: WatermarkEntry = { text: localize('watermark.openblueberryAIChat', "Open Chat"), id: 'treeai.focusContinueInput', when: ContextKeyExpr.has('blueberryAIExtensionLoaded') };
const bigChat: WatermarkEntry = { text: localize('watermark.blueberryAIBigChat', "Big Chat"), id: 'treeai.resizeAuxiliaryBarWidth', when: ContextKeyExpr.has('blueberryAIExtensionLoaded') };
const prevChat: WatermarkEntry = { text: localize('watermark.blueberryAIPrevChat', "Previous Chat"), id: 'treeai.loadRecentChat', when: ContextKeyExpr.has('blueberryAIExtensionLoaded') };
